"""
Django settings for real_backend project.
...
SECRET_KEY = 'django-insecure-j(#yn-3rzmwm%o3=yxd&i(v1lhc6x8i7)z=*=tqx^m(ok1tg_f'
...
ROOT_URLCONF = 'real_backend.urls'
...
WSGI_APPLICATION = 'real_backend.wsgi.application'
